...
void Shader::SetSpotLightsManual(SpotLight* sLight, unsigned int indice)
{

	glUniform1i(uniformSpotLightCount, 3);
...
void Shader::SetSpotLightsApagarUna(SpotLight* sLight, unsigned int indice)
{
	...
	unsigned int i = indice;
	sLight[i].NoUseLight(uniformSpotLight[i].uniformAmbientIntensity, uniformSpotLight[i].uniformColour,
		uniformSpotLight[i].uniformDiffuseIntensity, uniformSpotLight[i].uniformPosition, uniformSpotLight[i].uniformDirection,
		uniformSpotLight[i].uniformConstant, uniformSpotLight[i].uniformLinear, uniformSpotLight[i].uniformExponent,
		uniformSpotLight[i].uniformEdge);
