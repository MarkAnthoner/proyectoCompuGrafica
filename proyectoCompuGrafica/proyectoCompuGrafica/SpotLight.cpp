...
void SpotLight::NoUseLight(GLuint ambientIntensityLocation, GLuint ambientColourLocation,
	GLuint diffuseIntensityLocation, GLuint positionLocation, GLuint directionLocation,
	GLuint constantLocation, GLuint linearLocation, GLuint exponentLocation,
	GLuint edgeLocation)
{
	glUniform3f(ambientColourLocation, 0, 0, 0);
	glUniform1f(ambientIntensityLocation, 0);
	glUniform1f(diffuseIntensityLocation, 0);

	glUniform3f(positionLocation, 0, 0, 0);
	glUniform1f(constantLocation, 0);
	glUniform1f(linearLocation, 0);
	glUniform1f(exponentLocation, 0);

	glUniform3f(directionLocation, 0, 0, 0);
	glUniform1f(edgeLocation, 0);
}
