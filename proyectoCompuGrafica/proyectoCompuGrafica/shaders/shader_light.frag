...
uniform vec3 eyePosition;  //angulo desde donde se ve el brillo y reflejo
...
void main()
{
	...
	color=finalcolor*vColor*texture(theTexture, TexCoord);  //luz de tipo spotlight azul y luz roja puntual
}