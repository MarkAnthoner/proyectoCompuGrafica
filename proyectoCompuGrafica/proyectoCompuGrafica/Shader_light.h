...
public:
	...
	//funciones para manipular spotlights
	void SetSpotLightsManual(SpotLight* sLight, unsigned int indice);
	void SetSpotLightsApagarUna(SpotLight* sLight, unsigned int indice);
